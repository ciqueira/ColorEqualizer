# Política de Cancelamento e Reembolso do Color Equalizer
...
- recibo Stripe ou referência do Checkout, quando disponível; e
- descrição breve da solicitação.

Não publique dados de pagamento ou chaves em GitHub Issues. Informações
...
benefício comprado ou vício que não possa ser solucionado pelo procedimento
legal aplicável.
...
Essa regra não exclui direitos obrigatórios e não impede que o vendedor aprove
excepcionalmente um reembolso após analisar os fatos.

## 4. Efeito do reembolso

Quando o pagamento é reembolsado, a vigência de Supporter e o suporte
prioritário relacionado podem terminar. A licença gratuita e separada do Color
Equalizer não é automaticamente revogada apenas porque o pagamento de
Supporter foi reembolsado, salvo abuso independente da licença ou outro
fundamento legítimo.

O prazo para o valor aparecer após a aprovação depende do Stripe, meio de
pagamento e instituição financeira do comprador. Conversão de moeda e
processamento do emissor são controlados por esses provedores.

## 5. Disputas e chargebacks

Contatar o suporte primeiro normalmente permite análise mais rápida. Um
chargeback ou disputa pode marcar o benefício pago como em revisão durante a
apuração do Stripe e das instituições financeiras. Isso não elimina direitos
obrigatórios nem autoriza retaliação contra a licença gratuita não relacionada.
